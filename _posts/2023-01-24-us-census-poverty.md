...
This is the first part of the project, in which I analyze the Census data on poverty and incomes in the United States. Here, I focus on the data on poverty. The [next part](https://denislsad.github.io/posts/us-census-income/) is about income and income distribution. The latest available data from Census comes from the year 2021. You can find this project's data and code [on GitHub](https://github.com/denislsad/us-census-poverty).
